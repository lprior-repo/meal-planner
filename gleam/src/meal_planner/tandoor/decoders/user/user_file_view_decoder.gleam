...
import meal_planner/tandoor/types/user/user_file_view.{UserFileView}

/// Decode a UserFileView from JSON
///
...
pub fn decode(
  ...
  use created_by <- decode.field("created_by", user_decoder.decode)
