...
///
/// Creates a new recipe with all provided details. The server will auto-generate
/// the recipe ID and slug if not provided. Most fields are optional except for the name.
///
/// Example:
/// ```gleam
/// let recipe = MealieRecipe(
///   id: "",  // Will be set by server
///   slug: "",  // Auto-generated by Mealie from name
///   name: "Chicken Stir Fry",
///   description: Some("A quick and healthy dinner"),
///   recipe_yield: Some("4 servings"),
///   recipe_ingredient: [
///     MealieIngredient(
///       reference_id: "",
///       quantity: Some(1.0),
///       food: Some(MealieFood(id: "", name: "chicken breast", description: None)),
///       original_text: Some("1 lb chicken breast"),
///       is_food: True,
///       disable_amount: False,
///       display: "1 lb chicken breast",
///       note: None,
///       unit: None,
///     )
///   ],
///   recipe_instructions: [
///     MealieInstruction(id: "", title: Some("Cook"), text: "Heat oil and cook chicken")
///   ],
///   recipe_category: [],
///   tags: [],
///   nutrition: None,
...
///   date_updated: None,
/// )
/// case create_recipe(config, recipe) {
///   Ok(created) -> io.println("Created: " <> created.slug)
