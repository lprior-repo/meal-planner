...
///   zinc: None,
/// )
/// case save_food_log_from_mealie_recipe(conn, input) {
///   Ok(entry_id) -> io.println("Logged meal with ID: " <> entry_id)
///   Error(err) -> io.println("Failed to log meal: " <> string.inspect(err))
/// }
/// ```
