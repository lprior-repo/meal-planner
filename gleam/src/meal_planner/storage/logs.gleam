...
// Summary types re-exported from summaries module
...
/// Re-export calculation functions from summaries module
pub fn calculate_total_macros(entries: List(FoodLogEntry)) -> Macros {
  summaries.calculate_total_macros(entries)
}
...
pub fn calculate_total_micronutrients(
  ...
  summaries.calculate_total_micronutrients(entries)
}
