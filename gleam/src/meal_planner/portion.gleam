...
import gleam/list
import shared/types.{type Macros, type Recipe, Macros}
    ...
    False -> {
        ...
        recipe.macros.protein >. 0.0 && target_macros.protein >. 0.0
      {
        ...
        False -> {
          ...
          let recipe_calories = types.macros_calories(recipe.macros)
          let target_calories = types.macros_calories(target_macros)
      ...
      let scaled_macros = types.macros_scale(recipe.macros, capped_scale)
