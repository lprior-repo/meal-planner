...
pub fn recipe_ingredient_decoder() -> decode.Decoder(types.RecipeIngredient) {
  ...
  use serving_id <- decode.optional_field("serving_id", decode.string)
  ...
  use ingredient_url <- decode.optional_field("ingredient_url", decode.string)
...
pub fn recipe_decoder() -> decode.Decoder(types.Recipe) {
  ...
  use cooking_time_min <- decode.optional_field("cooking_time_min", decode.int)
  use rating <- decode.optional_field("rating", decode.float)
  ...
  use carbohydrate <- decode.optional_field("carbohydrate", decode.float)
  use protein <- decode.optional_field("protein", decode.float)
  use fat <- decode.optional_field("fat", decode.float)
  use saturated_fat <- decode.optional_field("saturated_fat", decode.float)
