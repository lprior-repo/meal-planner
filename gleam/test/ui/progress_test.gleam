...
pub fn progress_bar_renders_container_test() {
  ...
  assert_contains(result, "progress-bar")
}
...
pub fn progress_bar_with_full_progress_test() {
  let result = progress.progress_bar(100.0, 100.0, "success")
  assert_contains(result, "100")
}

pub fn progress_bar_with_color_test() {
  let result = progress.progress_bar(75.0, 100.0, "warning")
  assert_contains(result, "warning")
}

pub fn progress_bar_decimal_percentage_test() {
  let result = progress.progress_bar(33.33, 100.0, "primary")
  assert_contains(result, "33")
}
...
pub fn macro_bar_renders_percentage_test() {
  let result = progress.macro_bar("Carbs", 200.0, 300.0, "primary")
  assert_contains(result, "66")
}

pub fn macro_bar_contains_macro_bar_class_test() {
  let result = progress.macro_bar("Fat", 50.0, 75.0, "info")
  assert_contains(result, "macro-bar")
}

pub fn macro_bar_with_color_test() {
  let result = progress.macro_bar("Protein", 100.0, 150.0, "danger")
  assert_contains(result, "danger")
}

pub fn macro_bar_over_target_test() {
  let result = progress.macro_bar("Calories", 150.0, 100.0, "warning")
...
pub fn macro_badge_renders_label_test() {
  let result = progress.macro_badge("Protein", 150.0)
  assert_contains(result, "Protein")
}

pub fn macro_badge_renders_value_test() {
  let result = progress.macro_badge("Carbs", 250.0)
  assert_contains(result, "250")
}

pub fn macro_badge_contains_macro_badge_class_test() {
  let result = progress.macro_badge("Fat", 75.0)
  assert_contains(result, "macro-badge")
}

pub fn macro_badge_with_zero_value_test() {
  let result = progress.macro_badge("Sodium", 0.0)
  assert_contains(result, "0")
}
...
pub fn macro_badges_test() {
  ...
  assert_contains(result, "macro-badges")
}
...
pub fn status_badge_success_renders_test() {
  let result = progress.status_badge("Complete", ui_types.StatusSuccess)
  assert_contains(result, "Complete")
}

pub fn status_badge_warning_renders_test() {
  let result = progress.status_badge("Pending", ui_types.StatusWarning)
  assert_contains(result, "Pending")
}

pub fn status_badge_error_renders_test() {
  let result = progress.status_badge("Failed", ui_types.StatusError)
  assert_contains(result, "Failed")
}

pub fn status_badge_info_renders_test() {
  let result = progress.status_badge("Info", ui_types.StatusInfo)
  assert_contains(result, "Info")
}

pub fn status_badge_contains_status_badge_class_test() {
  let result = progress.status_badge("Active", ui_types.StatusSuccess)
  assert_contains(result, "status-badge")
}

pub fn status_badge_contains_status_type_class_test() {
  let result = progress.status_badge("Error State", ui_types.StatusError)
  assert_contains(result, "status-error")
}
...
pub fn progress_with_label_renders_label_test() {
  ...
  assert_contains(result, "Daily Goal")
}

pub fn progress_with_label_renders_percentage_test() {
  let result = progress.progress_with_label(45.0, 100.0, "Progress")
  assert_contains(result, "45")
}

pub fn progress_with_label_contains_class_test() {
  let result = progress.progress_with_label(80.0, 100.0, "Status")
  assert_contains(result, "progress-with-label")
}

pub fn progress_with_label_decimal_current_test() {
  let result = progress.progress_with_label(33.33, 100.0, "Metric")
  assert_contains(result, "33")
}
