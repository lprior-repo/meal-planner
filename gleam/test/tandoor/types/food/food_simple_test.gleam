...
pub fn food_simple_full_constructor_test() {
  let food = FoodSimple(id: 1, name: "Tomato", plural_name: Some("Tomatoes"))
...
pub fn food_simple_minimal_test() {
  let food = FoodSimple(id: 2, name: "Garlic", plural_name: None)
...
pub fn food_simple_optional_fields_test() {
  let food1 = FoodSimple(id: 3, name: "Onion", plural_name: Some("Onions"))
  let food2 = FoodSimple(id: 4, name: "Salt", plural_name: None)
