...
pub fn list_units_delegates_to_client_test() {
  ...
  let result = list.list_units(config, limit: Some(10), page: Some(1))
...
pub fn list_units_accepts_none_params_test() {
  ...
  let result = list.list_units(config, limit: None, page: None)
...
pub fn list_units_with_pagination_test() {
  ...
  let result = list.list_units(config, limit: Some(25), page: Some(2))
