...
import meal_planner/meal_plan.{
  ...
  meal_macros, weekly_plan_avg_daily_macros, weekly_plan_macros,
}
import meal_planner/types.{
  Active, Gain, Ingredient, Low, Macros, Maintain, Recipe, UserProfile,
}
...
pub fn generate_weekly_plan_each_day_has_meal_test() {
  ...
  let recipe =
    Recipe(
      id: "test-recipe",
      name: "Test Recipe",
      ingredients: [Ingredient(name: "Beef", quantity: "6 oz")],
      instructions: ["Grill"],
