...
pub fn test_auto_planner_production_filtering() {
  ...
  let non_compliant_recipe = Recipe(
...
pub fn test_food_logging_production_create_entry() {
  ...
  let log_input = logs.FoodLogInput(
    date: "2025-12-12",
...
pub fn test_food_logging_production_meal_types() {
  ...
  let valid_types = list.filter(meal_types, fn(t) {
...
pub fn test_food_logging_production_optional_nutrients() {
  ...
  let log_input = logs.FoodLogInput(
    ...
    fiber: Some(4.5),
    sugar: Some(2.0),
    sodium: None,  // Not populated
    cholesterol: None,  // Not populated
    vitamin_a: Some(800.0),  // Populated
    vitamin_c: None,
    vitamin_d: None,
    vitamin_e: None,
    vitamin_k: None,
  ...
  case log_input.sodium {
    Some(_) -> should.fail()
    None -> True |> should.equal(True)  // Expected None
  }
