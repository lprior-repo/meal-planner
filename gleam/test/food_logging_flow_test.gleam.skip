...
pub fn log_foods_multiple_meals_test() {
  ...
  // test_helpers.assert_macros_equal(
...
pub fn servings_scale_macros_correctly_test() {
  ...
  let recipe = test_helpers.fixture_high_protein_meal()
  ...
  // should.be_ok(result)
  // let entry = result.unwrap(result, ...)
  // test_helpers.assert_macros_equal(entry.macros, expected, 0.1)
...
pub fn fractional_servings_scale_macros_test() {
  let recipe = test_helpers.fixture_balanced_meal()
  ...
  let _ = test_helpers.assert_macros_equal(actual, expected, 0.1)
...
pub fn calories_calculated_from_macros_test() {
  ...
  let _ = test_helpers.assert_calories_correct(macros)
  should.be_true(True)
}
