...
fn test_empty_results() {
  ...
  case json.parse(empty_json, decoders.recipe_search_response_decoder()) {
    Ok(response) -> {
      io.println("✓ PASSED")
      io.println(
        "  Recipes count: " <> int.to_string(list.length(response.recipes)),
      )
...
fn test_single_recipe() {
  ...
  let single_json =
    "{\"recipes\": {\"recipe\": {\"recipe_id\": \"123\", \"recipe_name\": \"Chicken Curry\", \"recipe_description\": \"A delicious curry\", \"recipe_url\": \"http://example.com/123\"}, \"max_results\": 20, \"total_results\": 1, \"page_number\": 0}}"
...
fn test_multiple_recipes() {
  ...
  let multi_json =
    "{\"recipes\": {\"recipe\": [{\"recipe_id\": \"1\", \"recipe_name\": \"Recipe A\", \"recipe_description\": \"Description A\", \"recipe_url\": \"http://example.com/1\"}, {\"recipe_id\": \"2\", \"recipe_name\": \"Recipe B\", \"recipe_description\": \"Description B\", \"recipe_url\": \"http://example.com/2\"}], \"max_results\": 20, \"total_results\": 2, \"page_number\": 0}}"
