...
pub fn main() {
  ...
  case json.parse(empty_json, decoders.recipe_search_response_decoder()) {
    Ok(response) -> {
      ...
      io.println("  Recipes count: " <> String.inspect(List.length(response.recipes)))
  ...
  let single_json = "{\"recipes\": {\"recipe\": {\"recipe_id\": \"123\", \"recipe_name\": \"Test\", \"recipe_description\": \"Desc\", \"recipe_url\": \"http://example.com\"}, \"max_results\": 20, \"total_results\": 1, \"page_number\": 0}}"
  ...
  let multi_json = "{\"recipes\": {\"recipe\": [{\"recipe_id\": \"1\", \"recipe_name\": \"A\", \"recipe_description\": \"D1\", \"recipe_url\": \"http://a.com\"}, {\"recipe_id\": \"2\", \"recipe_name\": \"B\", \"recipe_description\": \"D2\", \"recipe_url\": \"http://b.com\"}], \"max_results\": 20, \"total_results\": 2, \"page_number\": 0}}"
