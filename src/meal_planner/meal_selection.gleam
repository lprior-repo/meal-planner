...
///
/// This module works with Recipe domain types from any source (Tandoor, local database,
/// or other recipe providers). All meal selection algorithms operate on the internal
