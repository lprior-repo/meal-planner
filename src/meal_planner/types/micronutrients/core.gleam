/// Micronutrient types and operations - Core implementation
///
...
///
/// CRITICAL: This module contains the opaque type definition and ALL functions
/// that access the internal structure. Gleam requires all opaque type accessors
/// to be in the same module as the type definition.
