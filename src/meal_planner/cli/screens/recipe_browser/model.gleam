/// Recipe Browser Model - State Types
///
/// This module contains all state types for the Recipe Browser screen.
/// Following Shore Framework (Elm Architecture) MVC pattern.
///
/// TYPES:
/// - RecipeModel: Root state container
/// - RecipeViewState: View state machine
/// - Display types: RecipeListItem, RecipeDetails, etc.
/// - Search/Filter types: RecipeSearchState, RecipeFilters, etc.
...
pub fn default_filters() -> RecipeFilters {
  RecipeFilters(
    max_calories: option.None,
    max_prep_time: option.None,
    min_protein: option.None,
    cuisine_type: option.None,
    diet_type: option.None,
