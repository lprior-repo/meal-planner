...
import meal_planner/fatsecret/diary_service
...
// ============================================================================
// POST /api/fatsecret/diary/commit-day - Commit/finalize a day
// ============================================================================

/// POST /api/fatsecret/diary/commit-day - Mark a day as complete/finalized
///
/// Request body (JSON):
/// ```json
/// {
