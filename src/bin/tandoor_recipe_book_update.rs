...
use meal_planner::tandoor::{TandoorClient, TandoorConfig, UpdateRecipeBookRequest};
...
fn run() -> anyhow::Result<Output> {
    ...
    let recipe_book = client.update_recipe_book(parsed.id, &serde_json::to_value(&request)?)?;
