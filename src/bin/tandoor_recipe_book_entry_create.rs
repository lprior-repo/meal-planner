...
use meal_planner::tandoor::{CreateRecipeBookEntryRequest, RecipeBookEntry, TandoorClient, TandoorConfig};
...
struct Output {
	...
	recipe_book_entry: Option<RecipeBookEntry>,
	#[serde(skip_serializing_if = "Option::is_none")]
	error: Option<String>,
}
...
fn run() -> anyhow::Result<Output> {
	...
	let recipe_book_entry = client.create_recipe_book_entry(&request)?;
