//! Get a single recipe step from Tandoor
//!
//! Retrieves a specific recipe step by ID from the Tandoor API.
//!
//! JSON input (CLI arg or stdin):
//!   `{"tandoor": {...}, "id": 123}`
//!
//! JSON stdout: `{"success": true, "step": {...}}`
...
fn run() -> anyhow::Result<Output> {
    ...
    let step = client.get_step(input.id)?;
