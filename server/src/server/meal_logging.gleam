    ...
    Ok(recipe) -> {
      ...
      let content = [
        ...
        html.div([attribute.class("log-form")], [
          html.p([attribute.class("instructions")], [
            element.text(
              "This will log 1 serving of " <> recipe.name <> " for today.",
            ),
          ]),
          // Preview macros
          html.div([attribute.class("macro-preview")], [
            ...
            html.div([attribute.class("macro-grid")], [
              ...
              macro_stat("Carbs", float_to_string(recipe.macros.carbs) <> "g"),
              macro_stat(
                "Calories",
