...
**API Documentation**: [docs/fatsecret/api-food-brands-get.md](api-food-brands-get.md)
...
- **food.categories.get.v2**: Similar pattern, also Premier scope (see [api-food-categories-get.md](api-food-categories-get.md))
