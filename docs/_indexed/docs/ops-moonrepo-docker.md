---
id: ops/moonrepo/docker-2
title: "Docker integration"
category: ops
tags: ["docker", "moonrepo", "operations", "advanced"]
---
...
- [`moon docker scaffold <project>`](/docs/commands/docker/scaffold)
- [`moon docker scaffold <project>`](/docs/commands/docker/scaffold)
- [`.moon/workspace.yaml`](/docs/config/workspace#scaffold)
