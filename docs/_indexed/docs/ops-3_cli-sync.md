...
title: "Sync"
category: ops
tags: ["operations", "advanced", "3_cli", "sync"]
---
...
During the push process, you will be prompted to decide whether to [re-encrypt](./ops-3_cli-workspace-management.md#managing-encryption-keys) the secrets of the workspace on the remote instance. In the case of instance migration, it is recommended to select "no" as the secrets are already encrypted with the correct key.


## See Also

- [branch-specific items](./branch-specific-items.mdx)
- [VS Code extension](../../cli_local_dev/1_vscode-extension/index.mdx)
- [wmill.yaml](#wmillyaml)
- [Git sync](../11_git_sync/index.mdx)
- [selected workspace](./workspace-management.md#selected-workspace)
