...
category: meta
tags: ["40_websocket_triggers", "meta", "websocket", "windmill", "advanced"]
---

# WebSocket triggers

> **Context**: Windmill can connect to [WebSocket](https://developer.mozilla.org/en-US/docs/Web/API/WebSockets_API) servers and trigger runnables (scripts, flows) wh
...
Like for [sync webhooks](./meta-4_webhooks-index.md#synchronous), if the flow has the [early return](./ops-flows-19-early-return.md) setting set, the chosen node result will be sent and the rest of the flow will continue asynchronously.
...
WebSocket triggers support local error handlers that override workspace error handlers for specific triggers. See the [error handling documentation](./meta-10_error_handling-index.md#trigger-error-handlers) for configuration details and examples.
...
- [WebSocket URL and runnable](./static_url.png 'WebSocket static URL')
- [WebSocket URL as runnable result](./runnable_url.png 'WebSocket URL as runnable result')
- [preprocessor](../43_preprocessors/index.mdx)
- [sync webhooks](../4_webhooks/index.mdx#synchronous)
