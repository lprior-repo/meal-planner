...
category: meta
tags: ["getting", "windmill", "00_how_to_use_windmill", "meta"]
---
...
For full control over your infrastructure, self-host Windmill using our [helm charts](https://github.com/windmill-labs/windmill-helm-charts) for Kubernetes or docker-compose for simpler setups. [Learn how to self-host Windmill](./meta-1_self_host-index.md).
...
### Local development
Prefer your own setup? No problem. Windmill integrates smoothly with local environments, including a [VS Code extension](./meta-1_vscode-extension-index.md) and tools for [Git-based deployment to production](./meta-12_deploy_to_prod-index.md). [Explore local development options](./meta-4_local_development-index.md).
<div className="grid grid-cols-2 gap-6 mb-4">
	<DocCard
...
Move from staging to production seamlessly with Windmill's deployment guides, ensuring your projects are production-ready. [Deploy to production](./meta-12_deploy_to_prod-index.md).

## See Also

- [Cloud Enterprise](/pricing)
- [Learn how to self-host Windmill](../../advanced/1_self_host/index.mdx)
- [built-in IDE](../../code_editor/index.mdx)
- [VS Code extension](../../cli_local_dev/1_vscode-extension/index.mdx)
- [Git-based deployment to production](../../advanced/12_deploy_to_prod/index.mdx)
