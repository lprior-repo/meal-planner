---
id: concept/windmill/2-early-stop
title: "Early stop / Break"
category: concept
tags: ["windmill", "concept", "early"]
---
...
- Optionally, toggle on "Label flow as "skipped" if stopped". Skipped flows are just a label useful to not see them in the [runs](./meta-windmill-index-76.md) page.
