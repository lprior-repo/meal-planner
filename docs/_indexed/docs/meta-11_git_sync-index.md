...
title: "Git sync"
category: meta
tags: ["11_git_sync", "advanced", "git", "meta"]
---
...
- [Deploy to prod using a git workflow](#git-sync---promotion-mode-deploy-to-prod-using-a-git-workflow)
- [Version control](../../advanced/13_version_control/index.mdx)
