...
category: meta
tags: ["meta", "version", "13_version_control"]
---
...
You can use [Windmill CLI](./meta-3_cli-index.md) to sync workspace to a git repository.
...
Scripts, Flows and Apps have unique [versions](./meta-34_versioning-index.md) when deployed. You can find the said version any time, fork it or go back to this version.
...
- [git_repository](../../integrations/git_repository.mdx)
...
- [versions](../../core_concepts/34_versioning/index.mdx)
