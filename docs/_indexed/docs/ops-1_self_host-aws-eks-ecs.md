...
category: ops
tags: ["operations", "windmill", "advanced", "aws", "1_self_host"]
---
...
## Windmill on AWS EKS
Windmill can be deployed on an EKS ([Elastic Kubernetes Service](https://aws.amazon.com/eks/)) cluster. Below are the detailed steps to get a Windmill stack up and running. The number of servers and [workers](./meta-9_worker_groups-index.md), as well as the instance sizes, should be tuned to your own usecases.
...
## Windmill on AWS ECS
Windmill can be deployed on an ECS ([Elastic Container Service](https://aws.amazon.com/ecs/)) cluster. Below are the detailed steps to get a Windmill stack up and running. The number of servers and [workers](./meta-9_worker_groups-index.md), as well as the instance sizes, should be tuned to your own usecases.
...
- [workers](../../core_concepts/9_worker_groups/index.mdx)
- [Helm chart](../self_host#helm-chart)
- [Windmill on AWS ECS](./aws_eks_ecs#create-a-rds-database)
- [Helm chart](../self_host#helm-chart)
- [workers](../../core_concepts/9_worker_groups/index.mdx)
