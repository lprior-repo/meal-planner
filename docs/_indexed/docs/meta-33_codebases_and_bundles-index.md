...
category: meta
tags: ["codebases", "33_codebases_and_bundles", "meta"]
---
...
The bundles requires [instance-wide object storage](./meta-38_object_storage_in_windmill-index.md#instance-object-storage) which is where the bundle resides.

## VS Code extension

This mode of deployment automatically works with the [VS Code extension](./meta-1_vscode-extension-index.md) to run preview by recognizing the `codebases` configuration in wmill.yaml and bundling scripts on the fly using the same esbuild.
...
- [Enterprise](/pricing)
- [relative imports](../../advanced/14_dependencies_in_typescript/index.mdx#sharing-common-logic-with-relative-imports-when-not-using-bundles)
- [using the package manager](../../advanced/14_dependencies_in_typescript/index.mdx#private-npm-registry--private-npm-packages)
- [wmill.yaml](#wmillyaml)
- [instance-wide object storage](../38_object_storage_in_windmill/index.mdx#instance-object-storage)
