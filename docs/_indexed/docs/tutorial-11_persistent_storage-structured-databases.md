...
category: tutorial
tags: ["big", "tutorial", "beginner", "sql", "11_persistent_storage"]
---
...
From Windmill, you can connect to most SQL services (PostgreSQL, MySQL, MS SQL, BigQuery, Snowflake) and execute queries, either with dedicated [SQL scripts](./meta-5_sql_quickstart-index.md), or through other languages ([Python](./meta-2_python_quickstart-index.md), [TypeScript](./meta-1_typescript_quickstart-index.md) etc.) using the appropriate libraries.
...
From Windmill [App editor](../../apps/0_app_editor/index.mdx), you can use the [Database studio](../../apps/4_app_configuration_settings/database_studio.mdx) component to visualize and manage your databases ([PostgreSQL](./meta-5_sql_quickstart-index.md#postgresql) / [MySQL](./meta-5_sql_quickstart-index.md#mysql) / [MS SQL](./meta-5_sql_quickstart-index.md#ms-sql) / [Snowflake](./meta-5_sql_quickstart-index.md#snowflake) / [BigQuery](./meta-5_sql_quickstart-index.md#bigquery)).
...
- [SQL scripts](../../getting_started/0_scripts_quickstart/5_sql_quickstart/index.mdx)
...
- [directly through its API](../../integrations/supabase.md#through-supabase-api)
