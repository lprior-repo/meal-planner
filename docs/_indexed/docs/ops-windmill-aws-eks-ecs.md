---
id: ops/windmill/aws-eks-ecs
title: "Windmill on AWS"
category: ops
tags: ["windmill", "aws", "advanced", "operations"]
---
...
## Windmill on AWS ECS
Windmill can be deployed on an ECS ([Elastic Container Service](https://aws.amazon.com/ecs/)) cluster. Below are the detailed steps to get a Windmill stack up and running. The number of servers and [workers](./meta-windmill-index-80.md), as well as the instance sizes, should be tuned to your own usecases.
