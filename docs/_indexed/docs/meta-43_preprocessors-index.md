...
title: "Preprocessors"
category: meta
tags: ["meta", "advanced", "43_preprocessors", "preprocessors"]
---
...
In [scripts](./meta-script_editor-index.md), you need to export an additional `preprocessor` function. 
...
Here are some templates for scripts with preprocessors in [TypeScript](./meta-1_typescript_quickstart-index.md) and [Python](./meta-2_python_quickstart-index.md):
...
For [flows](./tutorial-flows-1-flow-editor.md), the idea is similar but the preprocessor is a standalone step that returns only a `preprocessor` function.
...
Below you'll find preprocessor step templates for flows in [TypeScript](./meta-1_typescript_quickstart-index.md) and [Python](./meta-2_python_quickstart-index.md):
...
- [Scripts](#script-preprocessor)
- [flows](#flow-preprocessor)
- [webhook](../4_webhooks/index.mdx)
- [HTTP route](../39_http_routing/index.mdx)
- [email trigger](../../advanced/17_email_triggers/index.mdx)
