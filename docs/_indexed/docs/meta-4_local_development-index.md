...
category: meta
tags: ["advanced", "local", "4_local_development", "meta"]
---
...
Windmill has [its own integrated development environment](../../code_editor/index.mdx), but you can also develop and run scripts locally, both with [self-hosted](./meta-1_self_host-index.md) and cloud instances.
...
Syncing directly from the CLI is great, but instead of using the CLI directly, you should combine it with your CI/CD and set up a full productive Git workflow with a Staging and Prod workspaces and [Git sync](./meta-11_git_sync-index.md). See more details here:
...
To [run scripts locally](./ops-4_local_development-run-locally.md), you will need to fill out the context variables that would otherwise be filled out by the Windmill runtime for you.
...
- [its own integrated development environment](../../code_editor/index.mdx)
- [self-hosted](../1_self_host/index.mdx)
- [Develop Locally](#develop-locally)
- [Local development Recommended Setup](#local-development-recommended-setup)
- [version](../13_version_control/index.mdx)
