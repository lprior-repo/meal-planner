...
category: meta
tags: ["advanced", "dependency", "6_imports", "meta"]
---
...
See our dedicated page on [Dependencies in TypeScript](./meta-14_dependencies_in_typescript-index.md).
...
See our dedicated page on [Dependencies in Python](./meta-15_dependencies_in_python-index.md).
...
For [Nu](./meta-4_bash_quickstart-index.md#nu) you can import stdlib.
...
To import other scripts from your workspace, see [Sharing common logic](./meta-5_sharing_common_logic-index.md).

To import from a custom codebase, see [Codebases & bundles](./meta-33_codebases_and_bundles-index.md).
...
- [Dependency management & imports](./dependency_management.png "Dependency management & imports")
- [manage a package.json](../14_dependencies_in_typescript/index.mdx#lockfile-per-script-inferred-from-a-packagejson)
- [requirements.txt](../15_dependencies_in_python/index.mdx#lockfile-per-script-inferred-from-a-requirementstxt)
- [sharing common logic](../5_sharing_common_logic/index.mdx)
