---
id: tutorial/moonrepo/next
title: "Next example"
category: tutorial
tags: ["tutorial", "beginner", "next", "moonrepo"]
---
...
<doc_metadata>
  ...
  <description>In this guide, you&apos;ll learn how to integrate [Next.js](https://nextjs.org) into moon.</description>
  <created_at>2026-01-02T19:55:27.097003</created_at>
  <updated_at>2026-01-02T19:55:27.097003</updated_at>
  ...
  <tags>tutorial,beginner,next,moonrepo</tags>
</doc_metadata>
-->

# Next example

> **Context**: In this guide, you'll learn how to integrate [Next.js](https://nextjs.org) into moon.
...
> View the [official Next.js docs](https://nextjs.org/learn/basics/create-nextjs-app/setup) for a more in-depth guide to getting started!

## Setup

Since Next.js is per-project, the associated moon tasks should be defined in each project's [`moon.yml`](/docs/config/project) file.

tip

We suggest inheriting Next.js tasks from the [official moon configuration preset](https://github.com/moonrepo/moon-configs/tree/master/javascript/next).
