---
id: ops/windmill/gitsync-settings
title: "Git sync settings"
category: ops
tags: ["windmill", "advanced", "operations", "git"]
---
...
The command handles these git-sync configuration fields (see [wmill.yaml](./ops-windmill-sync.md#wmillyaml) for complete details):
...
- [wmill.yaml](./sync.mdx#wmillyaml)
- [promotion mode](../11_git_sync/index.mdx#promotion-mode)
- [wmill.yaml](./sync.mdx#wmillyaml)
