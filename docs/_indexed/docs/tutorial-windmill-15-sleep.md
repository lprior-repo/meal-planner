---
id: tutorial/windmill/15-sleep
title: "Sleeps / Delays in flows"
category: tutorial
tags: ["windmill", "tutorial", "beginner", "sleeps"]
---
...
Within a [flow](./meta-windmill-index-97.md), pick the step **after which** you want to suspend:
...
The [Runs menu](./meta-windmill-index-76.md) provides a dashboard to monitor all past, current and future runs. While a flow is executed and paused, you can see in a single view:
