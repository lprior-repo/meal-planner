...
category: meta
tags: ["workers", "9_worker_groups", "meta", "advanced"]
---
...
[Autoscaling](./meta-42_autoscaling-index.md) automatically adjusts the number of workers based on your workload demands.
...
- [Windmill's architecture](../../misc/10_architecture/index.md)
- [jobs](../20_jobs/index.mdx)
- [Workers page](./workers_page.png 'Workers page')
- [Community Edition](/pricing)
- [env variable](#how-to-assign-worker-tags-to-a-worker-group)
