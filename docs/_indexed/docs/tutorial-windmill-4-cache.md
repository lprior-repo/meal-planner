---
id: tutorial/windmill/4-cache
title: "Caching"
category: tutorial
tags: ["windmill", "tutorial", "caching", "beginner"]
---
...
[Step mocking / Pin result](./concept-windmill-5-step-mocking.md) allows faster iteration. When a step is mocked, it will immediately return the mocked value without performing any computation.
...
- [Caching result example](../assets/flows/cache_steps.gif)
- [Step mocking / Pin result](./5_step_mocking.md)
