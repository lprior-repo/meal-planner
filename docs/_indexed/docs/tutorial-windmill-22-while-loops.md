---
id: tutorial/windmill/22-while-loops
title: "While loops"
category: tutorial
tags: ["windmill", "tutorial", "beginner", "while"]
---
...
You can cancel flow manually from the flow page, it can be accessed when the flow is triggered manually or from the [Runs page](./meta-windmill-index-76.md).
...
- [Runs page](../core_concepts/5_monitor_past_and_future_runs/index.mdx)
...
- [Dedicated workers](../core_concepts/25_dedicated_workers/index.mdx)
- [test](../core_concepts/23_instant_preview/index.mdx)
