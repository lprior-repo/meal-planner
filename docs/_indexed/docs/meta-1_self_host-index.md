...
title: "Self-host"
category: meta
tags: ["selfhost", "advanced", "1_self_host", "meta"]
---
...
Then you will be redirected to the [Instance settings](./meta-18_instance_settings-index.md) page. You can always change the settings later.

![Instance settings](./instance_settings.png "Instance settings")

Then you can set up a new account that will override the default [superadmin](./meta-16_roles_and_permissions-index.md#superadmin) account. This is also where you can setup Hub Sync to use on your workspace [Resource types](./meta-3_resources_and_types-index.md) from [Windmill Hub](https://hub.windmill.dev/) ((by default, everyday)).
...
- [Windmill workers on Windows](../../misc/17_windows_workers/index.mdx)
- [Self-hosted Windmill](./self_hosted_windmill.png 'Self-hosted Windmill')
- [localhost](#docker)
