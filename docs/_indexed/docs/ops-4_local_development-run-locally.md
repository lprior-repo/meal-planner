...
title: "Run locally"
category: ops
tags: ["operations", "4_local_development", "advanced", "run"]
---
...
token, either create this in the UI, or use [wmill, the CLI](./meta-3_cli-index.md)
...
Windmill has its own extension on VS Code for local development & testing, see [VS Code extension](./meta-1_vscode-extension-index.md).
...
- [Local development page](./index.mdx)
- [fill out the context variables](#interacting-with-windmill-locally)
- [sections below](#interacting-with-windmill-locally)
- [wmill, the CLI](../3_cli/index.mdx)
