...
category: meta
tags: ["dependencies", "15_dependencies_in_python", "meta", "advanced", "python"]
---
...
- [standard mode](#lockfile-per-script-inferred-from-imports-standard)
- [Python](../../getting_started/0_scripts_quickstart/1_typescript_quickstart/index.mdx)
- [standard mode](#lockfile-per-script-inferred-from-imports-standard)
- [web IDE](#web-ide)
- [locally](#cli)
