---
id: ops/windmill/branch-specific-items
title: "Branch-specific items"
category: ops
tags: ["windmill", "operations", "advanced", "branchspecific"]
---
...
When [Git sync](./meta-windmill-index-2.md) is configured, branch-specific items work seamlessly with your Git repository setup. Git sync will automatically push changes to the correct branch-specific files based on the repository and branch configured in your `git_repository` resource.
...
- [CLI sync](./ops-windmill-sync.md) - Main sync operations and configuration
- [Git sync settings](./ops-windmill-gitsync-settings.md) - Managing sync configuration
- [Git sync](./meta-windmill-index-2.md) - Backend Git integration


## See Also

- [Git sync](../11_git_sync/index.mdx)
- [CLI sync](./sync.mdx)
- [Git sync settings](./gitsync-settings.mdx)
- [Git sync](../11_git_sync/index.mdx)
