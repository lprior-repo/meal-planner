...
category: concept
tags: ["large", "concept", "advanced", "11_persistent_storage"]
---
...
Windmill comes with a [native integration with S3, Azure Blob, and Google Cloud Storage](./meta-38_object_storage_in_windmill-index.md), making them the recommended storage for large objects like files and binary data.
...
- [native integration with S3, Azure Blob, and Google Cloud Storage](../38_object_storage_in_windmill/index.mdx)
- [Enterprise Edition](/pricing)
- [Workspace object storage infographic](../11_persistent_storage/s3_infographics.png 'Workspace object storage infographic')
- [set to public in the workspace settings](../38_object_storage_in_windmill/index.mdx#workspace-object-storage)
