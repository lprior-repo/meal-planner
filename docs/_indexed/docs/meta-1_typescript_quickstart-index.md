---
id: meta/1_typescript_quickstart/index
title: "TypeScript quickstart"
category: meta
tags: ["1_typescript_quickstart", "meta", "typescript", "advanced"]
---
...
Another approach is to write a program that defines the jobs and their dependencies, and then execute that program directly in your script. This is known as [workflows as code](./meta-31_workflows_as_code-index.md).
...
- Compose scripts in [Flows](./tutorial-flows-1-flow-editor.md) or [Apps](./meta-7_apps_quickstart-index.md).
...
- [handling dependencies in TypeScript](../../../advanced/14_dependencies_in_typescript/index.mdx)
