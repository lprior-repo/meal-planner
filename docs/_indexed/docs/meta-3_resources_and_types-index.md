...
category: meta
tags: ["3_resources_and_types", "resources", "advanced", "meta"]
---
...
Resources of type `json_schema` allow you to store reusable [JSON schemas](./meta-13_json_schema_and_parsing-index.md) that define the structure and validation rules for object parameters. 
...
- [Recap Resources and Types](./recap_resources_and_types.png 'Recap Resources and Types')
- [Assets](../52_assets/index.mdx)
- [S3 objects](../38_object_storage_in_windmill/index.mdx#workspace-object-storage)
- [list of integrations](../../integrations/0_integrations_on_windmill.mdx)
- [create your own](#create-a-resource-type)
