...
category: meta
tags: ["kafka", "41_kafka_triggers", "windmill", "meta"]
---

# Kafka triggers

> **Context**: Windmill can connect to [Kafka](https://kafka.apache.org/) brokers servers and trigger runnables (scripts, flows) when a message is received. Listenin
...
Kafka triggers support local error handlers that override workspace error handlers for specific triggers. See the [error handling documentation](./meta-10_error_handling-index.md#trigger-error-handlers) for configuration details and examples.
