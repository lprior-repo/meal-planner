---
id: tutorial/flows/1-flow-editor
title: "Flow editor"
category: tutorial
tags: ["flows", "beginner", "flow", "tutorial"]
---
...
> **Context**: import DocCard from '@site/src/components/DocCard'; import { Timer, TerminalSquare } from 'lucide-react';
...
In Windmill, each step is code with a main function in TypeScript, Python, Go, PHP, Bash or raw queries to databases. The result of a flow is the result of the last step executed, unless [error](./concept-flows-8-error-handling.md) was returned before or [Early return](./ops-flows-19-early-return.md) is set.
...
- [error](./8_error_handling.mdx)
- [Early return](./19_early_return.mdx)
- [Example of a flow](../assets/flows/flow_example.png)
