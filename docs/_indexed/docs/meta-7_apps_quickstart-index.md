...
category: meta
tags: ["apps", "7_apps_quickstart", "meta"]
---
...
When you're done with the editing of your app, [Save Draft](./meta-0_draft_and_deploy-index.md#draft) or [Deploy](./meta-0_draft_and_deploy-index.md#deployed-version) the current version to the relevant users/folders with a proper and explicit name. All additional changes can be seen and reversed in the [Diff Viewer](../../apps/0_toolbar.mdx#diff).
...
- [auto-generated UIs to scripts and flows](../../core_concepts/6_auto_generated_uis/index.mdx)
- [app editor](../../apps/0_app_editor/index.mdx)
- [importing your own React/Vue/Svelte apps](../../react_vue_svelte_apps/index.mdx)
- [datasources](../../integrations/0_integrations_on_windmill.mdx)
