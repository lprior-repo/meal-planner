...
category: meta
tags: ["browser", "meta", "windmill", "10_browser_automation", "api"]
---
...
- [read about it first](../../core_concepts/9_worker_groups/index.mdx)
- [init scripts](../../core_concepts/9_worker_groups/index.mdx#init-scripts)
