...
category: meta
tags: ["12_deploy_to_prod", "deploy", "meta"]
---
...
Deployments in Windmill are commonly done from the same workspace using the [Draft and deploy](./meta-0_draft_and_deploy-index.md) buttons.
...
- [Draft and deploy](#option-1-draft-and-deploy---single-workspace)
- [Git integration](#option-2-deploy-to-prod-using-a-git-workflow---multi-workspace-recommended)
- [UI to deploy to staging from dev](#option-3-deploy-to-prod-using-the-ui-only---multi-workspace)
- [Draft and deploy](../../core_concepts/0_draft_and_deploy/index.mdx)
- [local development](../4_local_development/index.mdx)
