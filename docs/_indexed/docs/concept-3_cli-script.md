...
title: "Scripts"
category: concept
tags: ["scripts", "windmill", "concept", "advanced", "3_cli"]
---
...
[Flows](./concept-3_cli-flow.md) inline script lockfiles can be also updated locally in the same way as `wmill script generate-metadata --lock-only` but for flows' inline scripts:
...
Below is a video on how to override Windmill inferred dependencies by [providing custom package.json](./meta-14_dependencies_in_typescript-index.md#lockfile-per-script-inferred-from-a-packagejson) or requirements.txt.
...
- [Flows](./flow.md)
- [providing custom package.json](../14_dependencies_in_typescript/index.mdx#lockfile-per-script-inferred-from-a-packagejson)
- [CLI arguments](../../assets/cli/cli_arguments.png 'CLI arguments')
