...
category: meta
tags: ["security", "security_isolation", "meta", "windmill", "advanced"]
---

# Security and process isolation

> **Context**: Windmill provides multiple layers of process isolation to protect your infrastructure from potentially malicious or buggy code execution. This page co
...
- [agent workers](/docs/core_concepts/agent_workers)
- [agent workers](/docs/core_concepts/agent_workers)
- [Worker Groups](/docs/core_concepts/worker_groups)
- [Self-Hosting](/docs/advanced/self_host)
