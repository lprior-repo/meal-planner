...
category: meta
tags: ["error", "advanced", "10_error_handling", "meta"]
---
...
Add a special script or flow to execute in case of an error in your [scheduled](./meta-1_scheduling-index.md) script or flow.
