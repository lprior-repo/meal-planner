---
id: tutorial/windmill/structured-databases
title: "Big structured SQL data: Postgres (Supabase, Neon.tech)"
category: tutorial
tags: ["sql", "tutorial", "big", "beginner", "windmill"]
---
...
From Windmill, you can connect to most SQL services (PostgreSQL, MySQL, MS SQL, BigQuery, Snowflake) and execute queries, either with dedicated [SQL scripts](./meta-windmill-index-91.md), or through other languages ([Python](./meta-windmill-index-88.md), [TypeScript](./meta-windmill-index-87.md) etc.) using the appropriate libraries.
