...
title: "Autoscaling"
category: meta
tags: ["42_autoscaling", "autoscaling", "advanced", "meta"]
---

# Autoscaling

> **Context**: Autoscaling automatically adjusts the number of workers based on your workload demands.
...
- [worker group](/core_concepts/9_worker_groups/index.mdx)
- [Autoscaling](./config.png)
