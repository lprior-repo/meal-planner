...
- [Resource Type](../3_resources_and_types/index.mdx)
- [Python](../../getting_started/0_scripts_quickstart/2_python_quickstart/index.mdx)
- [DynSelect_foo](#dynamic-select)
- [Deno, Bun](../../getting_started/0_scripts_quickstart/1_typescript_quickstart/index.mdx)
