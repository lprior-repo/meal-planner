---
id: concept/moonrepo/template
title: "template.{pkl,yml}"
category: concept
tags: ["advanced", "templatepklyml", "concept", "moonrepo"]
---
...
A human readable title that will be displayed during the [`moon generate`](/docs/commands/generate) process.
...
- [used by the generator](/docs/guides/codegen)
