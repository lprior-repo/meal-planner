...
title: "MQTT triggers"
category: meta
tags: ["windmill", "mqtt", "49_mqtt_triggers", "advanced", "meta"]
---

# MQTT triggers

> **Context**: Windmill can connect to an [**MQTT**](https://mqtt.org/mqtt-specification/) broker and trigger runnables (scripts, flows) in response to messages publ
...
MQTT triggers support local error handlers that override workspace error handlers for specific triggers. See the [error handling documentation](./meta-10_error_handling-index.md#trigger-error-handlers) for configuration details and examples.
