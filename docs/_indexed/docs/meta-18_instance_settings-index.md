...
category: meta
tags: ["18_instance_settings", "advanced", "instance", "meta"]
---
...
Instance settings are accessible to all [superadmins](./meta-16_roles_and_permissions-index.md#superadmin) of your Windmill instance. This is where you manage settings and features across all workspaces. One instance can have several workspaces.
...
The Admins workspace is for [superadmins](./meta-16_roles_and_permissions-index.md#superadmin) only and contains scripts whose purpose is to manage your Windmill instance, such as [keeping resource types up to date](./meta-3_resources_and_types-index.md#sync-resource-types-with-windmillhub) or the New User Setup App.

The [resources types](./meta-3_resources_and_types-index.md) created from the Admins workspace are shared across all workspaces.
...
- [superadmins](../../core_concepts/16_roles_and_permissions/index.mdx#superadmin)
- [Instance version](./instance_version.png "Instance version")
- [superadmins](../../core_concepts/16_roles_and_permissions/index.mdx#superadmin)
- [keeping resource types up to date](../../core_concepts/3_resources_and_types/index.mdx#sync-resource-types-with-windmillhub)
- [resources types](../../core_concepts/3_resources_and_types/index.mdx)
