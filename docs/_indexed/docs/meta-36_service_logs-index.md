...
title: "Service logs"
category: meta
tags: ["36_service_logs", "advanced", "service", "meta"]
---
...
As these are the logs of the whole windmill instance, only users with the [superadmin](./meta-16_roles_and_permissions-index.md#superadmin) or [devops](./meta-16_roles_and_permissions-index.md#devops) roles can see this page.


## See Also

- [workers](../9_worker_groups/index.mdx)
- [search modal](../35_search_bar/index.mdx)
- [Service logs](./service_logs.png "Service logs")
- [Workers](../9_worker_groups/index.mdx)
- [Service Logs On Menu](./service_logs_menu.png)
