...
When using Polars or DuckDB from Python, the S3 resource details need to be visible to the user, or [set to public in the workspace settings](./meta-windmill-index-55.md#workspace-object-storage).

:::

For more info on Data pipelines in Windmill, see [Data pipelines](./meta-windmill-index-43.md).
