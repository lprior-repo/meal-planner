...
category: ops
tags: ["operations", "advanced", "branchspecific", "3_cli"]
---
...
- [CLI sync](./ops-3_cli-sync.md) - Main sync operations and configuration
- [Git sync settings](./ops-3_cli-gitsync-settings.md) - Managing sync configuration
- [Git sync](./meta-11_git_sync-index.md) - Backend Git integration
