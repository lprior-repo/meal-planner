...
title: "Generated UI"
category: tutorial
tags: ["generated", "beginner", "script_editor", "tutorial"]
---
...
From the script's [Settings](./tutorial-script_editor-settings.md), pick "Generated UI" tab.
...
- [auto-generated UI](../core_concepts/6_auto_generated_uis/index.mdx)
- [JSON Schema](../core_concepts/13_json_schema_and_parsing/index.mdx)
- [Settings](./settings.mdx)
- [Python](../getting_started/0_scripts_quickstart/2_python_quickstart/index.mdx)
- [variable](../core_concepts/2_variables_and_secrets/index.mdx)
