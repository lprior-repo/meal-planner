...
title: "SQS triggers"
category: meta
tags: ["48_sqs_triggers", "meta", "windmill", "sqs", "aws"]
---

# SQS triggers

> **Context**: Windmill can connect to an [SQS](https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/welcome.html) queue and trigger runnables 
...
SQS triggers support local error handlers that override workspace error handlers for specific triggers. See the [error handling documentation](./meta-10_error_handling-index.md#trigger-error-handlers) for configuration details and examples.

## See Also

- [AWS resource](../../integrations/aws.md#aws-resource)
- [AWS OIDC resource](../../integrations/aws.md#aws-oidc-resource)
- [preprocessor](../43_preprocessors/index.mdx)
- [error handling documentation](../10_error_handling/index.mdx#trigger-error-handlers)
