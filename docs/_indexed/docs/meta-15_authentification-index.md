...
category: meta
tags: ["authentication", "15_authentification", "meta"]
---
...
- [through SSO](../../misc/2_setup_oauth/index.mdx)
- [Instance settings](../../advanced/18_instance_settings/index.mdx)
- [Manually Add Users](./add_global_users.png 'Manually Add Users')
- [SMTP is configured](../../advanced/18_instance_settings/index.mdx#smtp)
- [superadmins](../16_roles_and_permissions/index.mdx)
