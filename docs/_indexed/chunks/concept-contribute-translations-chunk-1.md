---
doc_id: concept/contribute/translations
chunk_id: concept/contribute/translations#chunk-1
...
> **Context**: Translations are managed on [translate.tandoor.dev](https://translate.tandoor.dev/), a self hosted instance of [Weblate](https://weblate.org/de/).
