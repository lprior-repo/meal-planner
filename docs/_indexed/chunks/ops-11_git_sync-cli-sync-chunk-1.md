---
doc_id: ops/11_git_sync/cli-sync
chunk_id: ops/11_git_sync/cli-sync#chunk-1
...
You can use [Windmill CLI](./meta-3_cli-index.md) to sync workspace to a git repository using `wmill sync pull` & `wmill sync push`.
