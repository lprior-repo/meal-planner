---
doc_id: ops/query/tasks
chunk_id: ops/query/tasks#chunk-3
heading_path: ["query tasks", "Find all tasks from projects with an id that matches \"react\""]
chunk_type: code
tokens: 371
summary: "Find all tasks from projects with an id that matches \"react\""
---
