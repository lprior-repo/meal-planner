---
doc_id: tutorial/windmill/1-flow-editor
chunk_id: tutorial/windmill/1-flow-editor#chunk-1
heading_path: ["Flow editor"]
chunk_type: prose
tokens: 1054
...
In Windmill, each step is code with a main function in TypeScript, Python, Go, PHP, Bash or raw queries to databases. The result of a flow is the result of the last step executed, unless [error](./concept-windmill-8-error-handling.md) was returned before or [Early return](./ops-windmill-19-early-return.md) is set.
