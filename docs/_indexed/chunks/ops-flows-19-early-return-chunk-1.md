---
doc_id: ops/flows/19-early-return
chunk_id: ops/flows/19-early-return#chunk-1
...
It is possible to define a node at which the flow will return at for [sync endpoints](./meta-4_webhooks-index.md#synchronous). The rest of the flow will continue asynchronously.
...
Webooks can be found on the flow page once [deployed](./meta-0_draft_and_deploy-index.md).
