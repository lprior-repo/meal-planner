---
doc_id: meta/51_sql_to_s3_streaming/index
chunk_id: meta/51_sql_to_s3_streaming/index#chunk-1
heading_path: ["S3 streaming for large queries"]
chunk_type: prose
tokens: 234
summary: "S3 streaming for large queries"
---

# S3 streaming for large queries

> **Context**: Sometimes, your SQL script will return too much data which exceeds the 10 000 rows query limit within Windmill. In this case, you will want to use the
