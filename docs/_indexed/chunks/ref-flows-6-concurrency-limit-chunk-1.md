---
doc_id: ref/flows/6-concurrency-limit
chunk_id: ref/flows/6-concurrency-limit#chunk-1
...
- [Max number of executions within the time window](./meta-21_concurrency_limits-index.md#max-number-of-executions-within-the-time-window)
- [Time window in seconds](./meta-21_concurrency_limits-index.md#time-window-in-seconds)
- [Custom concurrency key](./meta-21_concurrency_limits-index.md#custom-concurrency-key)
