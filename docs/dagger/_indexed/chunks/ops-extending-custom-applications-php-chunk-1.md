---
doc_id: ops/extending/custom-applications-php
chunk_id: ops/extending/custom-applications-php#chunk-1
heading_path: ["custom-applications-php"]
chunk_type: code
tokens: 542
summary: "> **Context**: > **Note:** The Dagger PHP SDK requires [PHP 8."
---
# PHP Custom Application

> **Context**: > **Note:** The Dagger PHP SDK requires [PHP 8.2 or later](https://www.php.net/downloads.php).
