...
chunk_id: tutorial/getting-started/quickstarts-ci#chunk-3
heading_path: ["quickstarts-ci", "Get the example application"]
chunk_type: mixed
tokens: 52
summary: "The example application is a skeleton Vue framework application that returns a \"Hello from Dagger!"
---
