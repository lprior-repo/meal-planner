---
doc_id: concept/getting-started/api-cli
chunk_id: concept/getting-started/api-cli#chunk-2
heading_path: ["api-cli", "Examples"]
chunk_type: code
tokens: 451
summary: "Here are a few examples:



Create a simple workflow that is fully satisfied by the core Dagger A..."
---
