---
doc_id: concept/extending/documentation
chunk_id: concept/extending/documentation#chunk-1
heading_path: ["documentation"]
chunk_type: code
tokens: 928
summary: "> **Context**: Dagger modules and Dagger Functions should be documented so that descriptions are ..."
---
# Inline Documentation

> **Context**: Dagger modules and Dagger Functions should be documented so that descriptions are shown in the API and the CLI - for example, when calling `dagger fun...
