...
chunk_id: concept/getting-started/types#chunk-6
heading_path: ["types", "Env"]
chunk_type: table
tokens: 233
summary: "The `Env` type represents an environment consisting of inputs and desired outputs, for use by an ..."
---
