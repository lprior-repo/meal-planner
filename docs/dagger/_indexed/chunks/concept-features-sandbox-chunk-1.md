---
doc_id: concept/features/sandbox
chunk_id: concept/features/sandbox#chunk-1
heading_path: ["sandbox"]
chunk_type: prose
tokens: 252
summary: "> **Context**: Dagger is built to protect your host environment by default."
---
# Sandboxed Runtime

> **Context**: Dagger is built to protect your host environment by default. All Dagger Functions are fully "sandboxed" and do not have direct access to the host syst...
...
> **Important:** By requiring typed arguments such as `Directory`, `Socket`, `Service`, or `Secret`, Dagger ensures users understand exactly what they are sharing with a Dagger Function. This explicit access design helps prevent malicious or untrusted modules from inadvertently obtaining sensitive data.
