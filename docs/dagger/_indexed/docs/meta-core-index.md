...
category: meta
tags: ["ci", "meta", "module", "function", "container"]
---

# What is Dagger?

> **Context**: Dagger is a platform for composing and running software engineering workflows - for example, complex integration testing environments, data processing...
...
- [Run workflows in your local development environment](./ops-core-use-cases.md#portable-ci), exactly as they run in remote CI
- [Enhance existing CI pipelines with LLMs](./ops-core-use-cases.md#agentic-ci) for code review, tests and feedback
- Improve build times, testing and dependency management in [monorepos](./ops-core-use-cases.md#monorepo-ci)

## Get started

- [Installation →](./ops-getting-started-installation.md) Install Dagger and set up your development environment
- [Basics →](/getting-started/quickstarts/basics) Learn Dagger fundamentals
- [CI Quickstart →](/getting-started/quickstarts/ci) Build your first workflow
...
[**Learn more about types →**](./concept-getting-started-types.md)
...
[**Learn more about Dagger Functions →**](./concept-extending-functions.md)
...
[**Learn more about Dagger modules →**](./ops-features-reusability.md)
...
[**Learn more about the Dagger CLI →**](./ops-reference-cli.md)
...
[**Learn more about the Dagger API →**](./concept-getting-started-concepts.md)
...
[**Learn more about Dagger SDKs →**](/getting-started/api/sdk)
...
- [Run workflows in your local development environment](./ops-core-use-cases.md)
- [Enhance existing CI pipelines with LLMs](./ops-core-use-cases.md)
- [monorepos](./ops-core-use-cases.md)
- [Installation →](./ops-getting-started-installation.md)
