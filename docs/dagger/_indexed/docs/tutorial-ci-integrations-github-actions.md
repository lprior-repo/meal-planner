---
id: tutorial/ci-integrations/github-actions
title: "GitHub Actions"
category: tutorial
tags: ["tutorial", "ci", "pipeline", "module", "container"]
---

# GitHub Actions

> **Context**: Dagger provides a GitHub Action that can be used in any GitHub Actions workflow to call one or more Dagger Functions on specific events, such as a new...
