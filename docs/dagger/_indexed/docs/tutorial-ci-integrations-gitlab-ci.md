---
id: tutorial/ci-integrations/gitlab-ci
title: "GitLab CI"
category: tutorial
tags: ["tutorial", "ci", "pipeline", "docker", "container"]
---

# GitLab CI

> **Context**: Dagger provides a programmable container engine that allows you to replace your YAML pipeline definitions in GitLab with Dagger Functions written in a...
