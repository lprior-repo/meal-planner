---
id: tutorial/core/faq
title: "Frequently Asked Questions"
category: tutorial
tags: ["tutorial", "ci", "docker", "module", "container"]
---

# Frequently Asked Questions

> **Context**: We're building the devops operating system, an integrated platform to orchestrate the delivery of applications to the cloud from start to finish. The...
...
Yes. It's possible to use the Dagger GraphQL API from any language that [supports GraphQL](https://graphql.org/code/) or from the [Dagger CLI](./ops-getting-started-installation.md).

## See Also

- [installation documentation](./ops-getting-started-installation.md)
- [Dagger CLI](./ops-getting-started-installation.md)
