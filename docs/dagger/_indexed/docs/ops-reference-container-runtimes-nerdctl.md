---
id: ops/reference/container-runtimes-nerdctl
title: "Nerdctl Runtime"
category: ops
tags: ["ops", "container", "ai"]
---

# Nerdctl Runtime

> **Context**: Dagger can be used with any OCI-compatible container runtime, including `nerdctl` and `finch`.
