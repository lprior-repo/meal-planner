---
id: tutorial/extending/daggerverse
title: "The Daggerverse"
category: tutorial
tags: ["file", "tutorial", "git", "module", "function"]
---

# The Daggerverse

> **Context**: Dagger Functions are packaged and shared using Dagger [modules](./ops-features-reusability.md).


Dagger Functions are packaged and shared using Dagger [modules](./ops-features-reusability.md).
...
Read about [best practices to improve module ranking](/reference/best-practices/modules).
