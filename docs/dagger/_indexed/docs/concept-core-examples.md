---
id: concept/core/examples
title: "Examples"
category: concept
tags: ["ci", "pipeline", "docker", "container", "concept"]
---

# Examples

> **Context**: This page showcases real-world examples of Dagger in action, with a focus on working implementations you can study and adapt.
...
> **Info:** Watch a [livestream of building an AI agent with Dagger](https://www.youtube.com/watch?v=1rDcyiR0wZE).
...
- [Filesystem operations](./concept-cookbook-filesystems.md): Working with files and directories
- [Build operations](./ops-cookbook-builds.md): Building applications and container images
- [Agentic operations](./ops-cookbook-agents.md): Working with agents and environments
- [Service management](./ops-cookbook-services.md): Working with services and networking
- [Secret management](./concept-cookbook-secrets.md): Managing sensitive data securely
- [Troubleshooting](./ops-cookbook-errors.md): Handling and debugging errors
...
- [Filesystem operations](./concept-cookbook-filesystems.md)
- [Build operations](./ops-cookbook-builds.md)
- [Agentic operations](./ops-cookbook-agents.md)
- [Service management](./ops-cookbook-services.md)
