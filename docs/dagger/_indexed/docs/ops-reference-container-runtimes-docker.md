---
id: ops/reference/container-runtimes-docker
title: "Docker Runtime"
category: ops
tags: ["ops", "docker", "ai", "container", "install"]
---

# Docker Runtime

> **Context**: Dagger can be used with any OCI-compatible container runtime, including Docker.
