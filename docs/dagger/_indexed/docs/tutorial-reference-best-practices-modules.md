---
id: tutorial/reference/best-practices-modules
title: "Module Testing and Publishing"
category: tutorial
tags: ["tutorial", "module", "function", "python", "go"]
---

# Module Testing and Publishing

> **Context**: Best practices for testing and publishing Dagger modules.


Best practices for testing and publishing Dagger modules.
...
To get the best possible rank in the Daggerverse:

1. Add a **description** to your module
2. Add **descriptions** to module functions
3. Tag versions with **semver**
4. Create hand-crafted **examples**
