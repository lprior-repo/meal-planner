...
> **Important:** Dagger modules have only one constructor. Constructors of [custom types](/extending/custom-types) are not registered; they are constructed by the function that chains them.
