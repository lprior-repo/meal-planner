...
- [Filesystem operations](/cookbook/filesystems): Working with files and directories
- [Build operations](/cookbook/builds): Building applications and container images
- [Agentic operations](/cookbook/agents): Working with agents and environments
...
- [Troubleshooting](/cookbook/errors): Handling and debugging errors
