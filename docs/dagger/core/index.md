...
- [Run workflows in your local development environment](/use-cases#portable-ci), exactly as they run in remote CI
- [Enhance existing CI pipelines with LLMs](/use-cases#agentic-ci) for code review, tests and feedback
- Improve build times, testing and dependency management in [monorepos](/use-cases#monorepo-ci)

## Get started

- [Installation →](/getting-started/installation) Install Dagger and set up your development environment
...
[**Learn more about types →**](/getting-started/types)
...
[**Learn more about Dagger Functions →**](/extending/functions)
...
[**Learn more about Dagger modules →**](/features/reusability)
...
[**Learn more about the Dagger CLI →**](/reference/cli)
...
[**Learn more about the Dagger API →**](/getting-started/concepts)
