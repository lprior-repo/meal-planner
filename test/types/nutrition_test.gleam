...
import meal_planner/types/nutrition.{
  NutritionGoals, NutritionData, DeviationResult, TrendDirection, Increasing,
  Decreasing, Stable, NutritionState, ScoredRecipe,
  calculate_deviation, deviation_is_within_tolerance, deviation_max,
  average_nutrition_history, calculate_consistency_rate,
  get_default_goals, calculate_daily_totals, calculate_macro_percentages,
  check_macro_targets, suggest_macro_adjustments, estimate_daily_calories,
  nutrition_goals_validate, analyze_nutrition_trends,
}
