...
pub fn profile_decoder_full_response_test() {
  let json_str =
    json.object([
      ...
      #("last_weight_date_int", json.int(20_251_214)),
...
pub fn profile_auth_decoder_valid_response_test() {
  let json_str =
    json.object([
      #("auth_token", json.string("***REMOVED***")),
...
pub fn profile_auth_construction_test() {
  let auth = ProfileAuth(auth_token: "token-xyz", auth_secret: "secret-abc")
...
pub fn profile_with_all_fields_test() {
  let profile =
    Profile(
      ...
      last_weight_date_int: Some(20_251_214),
