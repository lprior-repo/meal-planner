...
pub fn plan_list_grouped_by_date_output_test() {
  ...
  let meal_plans = [
    test_meal_plan_entry(1, "2025-12-20", Breakfast, 101, "Oatmeal"),
    test_meal_plan_entry(2, "2025-12-20", Lunch, 102, "Chicken Salad"),
    test_meal_plan_entry(3, "2025-12-20", Dinner, 103, "Grilled Salmon"),
    test_meal_plan_entry(4, "2025-12-21", Breakfast, 104, "Scrambled Eggs"),
  ]
